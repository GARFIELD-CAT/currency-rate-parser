...
- **Thread Dumps**: Я использовал для анализа состояния потоков в приложении.
![img_3.png](img_3.png)

- **Heap Dumps**: Я изучал активные объекты, чтобы выяснить, какие из них занимаются больше всего памяти.
![img_2.png](img_2.png)
![img_4.png](img_4.png)
...
Объекты быстро создаютс яи удаляются. Утечек памяти нет.
![img_2.png](img_2.png)
